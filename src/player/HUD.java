...
public class HUD {
	...
	public void setSize(double size){
	 ...
	 public Rectangle getPowerSolderClickArea(){
		 if (player.hasPowerSolder()) return powerSolder.clickArea();
	...
	public void render(Graphics2D g2d){
		...
		Font smallFont = font.deriveFont((float) (size*8f));;
		g2d.setFont(bigFont);
		
		g2d.setColor((player.getChargeTokens()==0?Color.YELLOW:new Color(0, 0, 0, 128)));
		g2d.fillRoundRect((int)(xPos-5*size), (int)(yPos-5*size), (int)(50*size), (int)(50*size), (int)(25*size), (int)(25*size));
		for (int i=0; i<3; i++)
			for(int j=0;j<3-i;j++)
				g2d.fillRoundRect((int)(xPos-22-j*14*size), (int)(yPos+(-4+i*15)*size), (int)(15*size), (int)(15*size), (int)(7*size), (int)(7*size));
		
		g2d.setColor(player.getColor());
		g2d.fillRoundRect(xPos, yPos, (int)(40*size), (int)(40*size), (int)(20*size), (int)(20*size));
		for (int i=0; i<3; i++)
			for(int j=0;j<3-i;j++)
				g2d.fillRoundRect((int)(xPos-20-j*13*size), (int)(yPos+(-2+i*15)*size), (int)(12*size), (int)(12*size), (int)(6*size), (int)(6*size));
		
		g2d.setColor(Color.WHITE);
		g2d.drawString(Integer.toString(player.getChargeTokens()), (int)(10+xPos+size), (int)(size*30)+yPos);
		g2d.setFont(smallFont);
		for (int i=0; i<3; i++)
			g2d.drawString(Integer.toString(player.getCircDelay(3-i)), (int)(xPos+size-18), (int)(yPos+(+8+i*15)*size));
